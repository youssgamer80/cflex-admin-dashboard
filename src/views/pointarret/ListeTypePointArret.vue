...
const queryData = (params) => {
  return axios.get("http://192.168.252.135:4001/api/v1/TypePointArret/getTypePointArrets", {
    params,
  });
};
...
export default defineComponent({
  ...
  setup() {
    ...
    const onSubmit = async () => {
      visible.value = false;
      const resp = await axios.put(`http://192.168.252.135:4001/api/v1/TypePointArret/updateTypePointArret/${formState.id}`,
        {
    ...
    const onDelete = (id) => {
      return axios
        .delete(
          `http://192.168.252.135:4001/api/v1/TypePointArret/deleteTypePointArret/${id}`,
          {
            data: {
              statut: false,
            },
